...
export class OrderComponent  implements OnInit {
  ...
  orderStatus: any;
  constructor(private route: ActivatedRoute, private _orderServ: OrderServiceService, private _route: Router, private  _toastService: ToastService,private _statusbar : StatusbarService) {
